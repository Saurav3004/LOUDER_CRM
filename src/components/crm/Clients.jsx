...
const Clients = () => {
  ...
  const clients = [{
    ...
    },
    {
      ...
      dietaryRestrictions: 'None',
      avatar: 'https://images.pexels.com/photos/874158/pexels-photo-874158.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&dpr=2'
    },
    {
      id: '5',
      name: 'Lisa Wilson',
    ...
    <div className="p-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600">Manage your users contacts and details.</p>
        </div>
  ...
  <tr>
    ...
    <th className="px-6 py-3 text-left text-sm font-semibold text-gray-500">Users</th>
              ...
              <tr key={client.id} className="hover:bg-gray-50 transition">
                ...
                <td className="px-6 py-4 text-sm text-gray-700">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>{client.bookingStatus}</span>
                  </div>
                </td>
